...
public sealed class RaitPrimitiveTests : RaitTestBase
{
    ...
    {
        var result = await Client.Rait<RaitPrimitiveTypesTestController>().Call(n => n.GetInt());
    ...
    {
        var call = await Client.Rait<RaitPrimitiveTypesTestController>().Call(n => n.GetString());
    ...
    {
        var result = await Client.Rait<RaitPrimitiveTypesTestController>().Call(n => n.GetGuid());
    ...
    {
        var result = await Client.Rait<RaitPrimitiveTypesTestController>().Call(n => n.GetBool());
    ...
    {
        var result = await Client.Rait<RaitPrimitiveTypesTestController>().Call(n => n.GetObject());
